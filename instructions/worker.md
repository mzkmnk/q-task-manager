...
### 1. タスク分析
`../task.md`の内容を詳細に分析し、あなたの担当するアプローチを理解してください。

### 2. 独自アプローチの決定
- **Worker1**: 技術詳細重視のアプローチ
- **Worker2**: 初心者フレンドリー重視のアプローチ
- **Worker3**: 実践・運用重視のアプローチ

### 3. 作業実行
独立したGit worktree環境で、あなた独自のアプローチでタスクを実行してください。
